...
public class Artillery4_AngleInteractive extends JFrame {
	private JLabel rangeL, speedL;
	private JScrollBar range, speed;
	private JButton button;
	private Artillery3_AngleAnimated ani;
	
	public Artillery4_AngleInteractive() {
		super("Artillery");
		setSize(800, 650);
		setResizable(false);
		...
		ani = new Artillery3_AngleAnimated();
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == button) {
					ani.setVars(range.getValue(), speed.getValue());
				}
			}
		});
	...
	public static void main(String[] args) {
		new Artillery4_AngleInteractive();
	}
}
